...
def load_all_data():
    ...
    load_order = [
        "data/ontology.ttl",              # 1. Ontology first           V
        "data/tolkien_pages_entities.ttl", # 2. Pages/entities          V
        "data/all_characters_schema.ttl",  # 3. Characters              V   
        "data/metw_integration_cards.ttl", # 4. Cards                   V
        "data/multilingual_labels_only.ttl", # 5. Multilingual labels   V
        "data/api_alignments.ttl",        # 6. Alignments               V
        #"kg/final_knowledge_graph.ttl",   # 7. Final merged (optional)  X
        #"shapes/tolkien_shacl_shapes.ttl", # 8. SHACL shapes            X
    ]
